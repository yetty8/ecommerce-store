...
export default function ProductCard({ id, name, price, img }) {
  ...
  return (
    <div className="bg-gray-800 dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-xs mx-auto">
      <img
        src={img}
        alt={name}
